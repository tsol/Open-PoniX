...
"i686-linux-3.2.16-030216-generic" or
	die "Errno architecture (i686-linux-3.2.16-030216-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
