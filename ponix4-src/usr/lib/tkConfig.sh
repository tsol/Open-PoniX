...
TK_LIBS='-lX11 -lXss -lXext   -ldl  -lieee -lm'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/source/tk8.5.12/unix -ltk8.5'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/source/tk8.5.12/unix -ltkstub8.5'
...
TK_BUILD_STUB_LIB_PATH='/source/tk8.5.12/unix/libtkstub8.5.a'
