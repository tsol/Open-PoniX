...
TCL_CC='i486-TSOL-linux-gnu-gcc'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/source/tcl8.5.12/unix -ltcl8.5'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/source/tcl8.5.12/unix -ltclstub8.5'
...
TCL_BUILD_STUB_LIB_PATH='/source/tcl8.5.12/unix/libtclstub8.5.a'
