...
enum opt_code
{
  ...
  OPT_masm_ = 960,                           /* -masm= */
  OPT_mavx = 961,                            /* -mavx */
  OPT_mavx256_split_unaligned_load = 962,    /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 963,   /* -mavx256-split-unaligned-store */
  ...
  OPT_mhard_float = 984,                     /* -mhard-float */
  OPT_mieee_fp = 985,                        /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 986,       /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 987,           /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 988,   /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 989, */             /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 990,          /* -mlarge-data-threshold= */
  OPT_mlwp = 991,                            /* -mlwp */
  OPT_mmmx = 992,                            /* -mmmx */
  OPT_mmovbe = 993,                          /* -mmovbe */
  OPT_mms_bitfields = 994,                   /* -mms-bitfields */
  OPT_mno_align_stringops = 995,             /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 996,              /* -mno-fancy-math-387 */
  OPT_mno_push_args = 997,                   /* -mno-push-args */
  OPT_mno_red_zone = 998,                    /* -mno-red-zone */
  OPT_mno_sse4 = 999,                        /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1000,       /* -momit-leaf-frame-pointer */
  OPT_mpc = 1001,                            /* -mpc */
  OPT_mpclmul = 1002,                        /* -mpclmul */
  OPT_mpopcnt = 1003,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1004,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1005,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1006,                     /* -mpush-args */
  OPT_mrdrnd = 1007,                         /* -mrdrnd */
  OPT_mrecip = 1008,                         /* -mrecip */
  OPT_mred_zone = 1009,                      /* -mred-zone */
  OPT_mregparm_ = 1010,                      /* -mregparm= */
  OPT_mrtd = 1011,                           /* -mrtd */
  OPT_msahf = 1012,                          /* -msahf */
  OPT_msoft_float = 1013,                    /* -msoft-float */
  OPT_msse = 1014,                           /* -msse */
  OPT_msse2 = 1015,                          /* -msse2 */
  OPT_msse2avx = 1016,                       /* -msse2avx */
  OPT_msse3 = 1017,                          /* -msse3 */
  OPT_msse4 = 1018,                          /* -msse4 */
  OPT_msse4_1 = 1019,                        /* -msse4.1 */
  OPT_msse4_2 = 1020,                        /* -msse4.2 */
  OPT_msse4a = 1021,                         /* -msse4a */
  /* OPT_msse5 = 1022, */                    /* -msse5 */
  OPT_msseregparm = 1023,                    /* -msseregparm */
  OPT_mssse3 = 1024,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1025,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1026,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1027,            /* -mstringop-strategy= */
  OPT_mtbm = 1028,                           /* -mtbm */
  OPT_mtls_dialect_ = 1029,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1030,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1031,                         /* -mtune= */
  OPT_muclibc = 1032,                        /* -muclibc */
  OPT_mveclibabi_ = 1033,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1034,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1035,                    /* -mvzeroupper */
  OPT_mxop = 1036,                           /* -mxop */
  OPT_n = 1037,                              /* -n */
  ...
  OPT_time = 1111,                           /* -time */
  OPT_time_ = 1112,                          /* -time= */
  OPT_tno_android_cc = 1113,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1114,                 /* -tno-android-ld */
