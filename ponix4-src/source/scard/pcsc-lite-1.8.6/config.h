...
/* pcscd filename */
#define PCSCD_BINARY "/7/sbin/pcscd"

/* Enabled PC/SC lite features */
#define PCSCLITE_FEATURES " Linux i686-pc-linux-gnu serial usb libudev usbdropdir=/7/lib/pcsc/drivers ipcdir=/var/run/pcscd configdir=/7/etc/reader.conf.d"

/* directory containing USB drivers */
#define PCSCLITE_HP_DROPDIR "/7/lib/pcsc/drivers"
