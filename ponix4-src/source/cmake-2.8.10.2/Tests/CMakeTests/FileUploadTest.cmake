file(REMOVE_RECURSE "/source/cmake-2.8.10.2/Tests/CMakeTests/uploads")

if(EXISTS "/source/cmake-2.8.10.2/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/source/cmake-2.8.10.2/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/source/cmake-2.8.10.2/Tests/CMakeTests/uploads")

set(filename "/source/cmake-2.8.10.2/Tests/CMakeTests/FileDownloadInput.png")
set(urlbase "file:///source/cmake-2.8.10.2/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/source/cmake-2.8.10.2/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/source/cmake-2.8.10.2/Tests/CMakeTests/uploads/file2.png"
