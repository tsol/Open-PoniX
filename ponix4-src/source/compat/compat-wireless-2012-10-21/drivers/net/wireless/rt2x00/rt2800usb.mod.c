...
MODULE_ALIAS("usb:v0411p01EEd*dc*dsc*dp*ic*isc*ip*");
...
MODULE_ALIAS("usb:v0FE9pB307d*dc*dsc*dp*ic*isc*ip*");
...
MODULE_ALIAS("usb:v050Dp945Bd*dc*dsc*dp*ic*isc*ip*");
...
MODULE_INFO(srcversion, "F5A4C52EE073F4BF1E992DE");
