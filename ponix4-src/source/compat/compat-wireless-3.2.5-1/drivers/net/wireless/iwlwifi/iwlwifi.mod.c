...
MODULE_ALIAS("pci:v00008086d00000082sv*sd00001341bc*sc*i*");
...
MODULE_ALIAS("pci:v00008086d00000890sv*sd00004026bc*sc*i*");
MODULE_ALIAS("pci:v00008086d00000891sv*sd00004226bc*sc*i*");
MODULE_ALIAS("pci:v00008086d00000890sv*sd00004426bc*sc*i*");
...
MODULE_ALIAS("pci:v00008086d00000887sv*sd00004066bc*sc*i*");
MODULE_ALIAS("pci:v00008086d00000888sv*sd00004266bc*sc*i*");
MODULE_ALIAS("pci:v00008086d00000887sv*sd00004466bc*sc*i*");
...
MODULE_ALIAS("pci:v00008086d0000088Esv*sd00004064bc*sc*i*");
MODULE_ALIAS("pci:v00008086d0000088Fsv*sd00004264bc*sc*i*");
MODULE_ALIAS("pci:v00008086d0000088Esv*sd00004464bc*sc*i*");
MODULE_ALIAS("pci:v00008086d0000088Esv*sd00004066bc*sc*i*");
MODULE_ALIAS("pci:v00008086d0000088Fsv*sd00004266bc*sc*i*");
MODULE_ALIAS("pci:v00008086d0000088Esv*sd00004466bc*sc*i*");
...
MODULE_ALIAS("pci:v00008086d00000894sv*sd00000026bc*sc*i*");
MODULE_ALIAS("pci:v00008086d00000895sv*sd00000226bc*sc*i*");
MODULE_ALIAS("pci:v00008086d00000894sv*sd00000426bc*sc*i*");
...
MODULE_ALIAS("pci:v00008086d00000892sv*sd00000066bc*sc*i*");
MODULE_ALIAS("pci:v00008086d00000893sv*sd00000266bc*sc*i*");
MODULE_ALIAS("pci:v00008086d00000892sv*sd00000466bc*sc*i*");

MODULE_INFO(srcversion, "5074A2D0906EED389DD30BA");
