cmd_scripts/conmakehash := gcc -Wp,-MD,scripts/.conmakehash.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer   -I./tools/include  -o scripts/conmakehash scripts/conmakehash.c  
...
deps_scripts/conmakehash := \
  ...
  /toolchain/i486-TSOL-linux-gnu/sysroot/usr/include/sysexits.h \
