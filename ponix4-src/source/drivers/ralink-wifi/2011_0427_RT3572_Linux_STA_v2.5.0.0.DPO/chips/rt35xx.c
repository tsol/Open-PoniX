...
VOID 	RT35xx_ChipResumeMsduTransmission(
	IN	PRTMP_ADAPTER		pAd);
	...
	IN PRTMP_ADAPTER		pAd)
{
	...
	pChipOps->RTMPSetAGCInitValue = RT35xx_SetAGCInitValue;
	pChipOps->ChipResumeMsduTransmission = RT35xx_ChipResumeMsduTransmission;
#ifdef CONFIG_STA_SUPPORT
	pChipOps->ChipStaBBPAdjust = RT35xx_ChipStaBBPAdjust;
	...
	IN	PRTMP_ADAPTER		pAd)
{
	...
	for(IdReg=0; IdReg<RT35xx_NUM_MAC_REG_PARMS; IdReg++)
	{
		...
		RTMP_IO_WRITE32(pAd, RT35xx_MACRegTable[IdReg].Register,
