...
#ifdef RT2870
#define RTMP_DRV_NAME	"rt2870" xdef_to_str(RT28xx_MODE)
#define RT_CHIPSET		2870
RTMP_DECLARE_DRV_OPS_FUNCTION(2870);
#define RTMP_DRV_OPS_FUNCTION				RTMP_DRV_OPS_FUNCTION_BODY(2870)
#define RTMP_BUILD_DRV_OPS_FUNCTION_BODY	RTMP_BUILD_DRV_OPS_FUNCTION(2870)
#endif /* RT2870 */
