...
#ifdef RT3290
#define BT_ON(_p)			(OPSTATUS_TEST_FLAG(_p, fOP_STATUS_BT_ON))
//This flag is enabled in the period of BTHS connecting. In other word, BTHS auth, assoc, and 4 way handshaking.
#define BT_4WAY(_p)			(OPSTATUS_TEST_FLAG(_p, fOP_STATUS_BT_4WAY))
#define BT_SKIPSCAN(_p)		(OPSTATUS_TEST_FLAG(_p, fOP_STATUS_BT_ON) && OPSTATUS_TEST_FLAG(_p, fOP_STATUS_BT_ON_SKIPSCAN))
...
#define MONITOR_FLAG_11N_SNIFFER		0x01
	...
	*/
	...
	BOOLEAN  bDelayedPhyPowerIndication;
#endif				/* RTMP_MAC_PCI */
