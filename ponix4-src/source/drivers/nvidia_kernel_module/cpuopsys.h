...
// Until we make SIM_BUILD vs. NV_VERIF_FEATURES orthogonal in the RM
// codepaths, a simulation build (previously only arch NV_MODS) also
// requires NV_VERIF_FEATURES for sims to work properly.
