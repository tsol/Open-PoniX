...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -Os -DFT_CONFIG_OPTION_SYSTEM_ZLIB -DFT_CONFIG_OPTION_USE_BZIP2 -I/usr/include/libpng12 -DFT_CONFIG_OPTION_USE_PNG -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS := -static-libgcc -lz -lbz2 -L/usr/lib -lpng12


# export symbols
#
CCraw_build  := i486-TSOL-linux-gnu-gcc	# native CC of building system
