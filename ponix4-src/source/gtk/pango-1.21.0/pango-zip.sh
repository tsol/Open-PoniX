...
ZIP=/tmp/pango-1.21.0.zip
DEVZIP=/tmp/pango-dev-1.21.0.zip
cd /usr

mkdir -p share/doc/pango-1.21.0
cp -p /source/gtk/pango-1.21.0/COPYING share/doc/pango-1.21.0

mkdir -p share/doc/pango-dev-1.21.0
cp -p /source/gtk/pango-1.21.0/COPYING share/doc/pango-dev-1.21.0
...
zip -r $ZIP share/doc/pango-1.21.0
...
zip -r $DEVZIP share/doc/pango-dev-1.21.0
