...
ZIP=/tmp/gtk+-2.24.16.zip
DEVZIP=/tmp/gtk+-dev-2.24.16.zip
cd /usr

mkdir -p share/doc/gtk+-2.24.16
cp -p /source/gtk/2.24/gtk+-2.24.16/COPYING share/doc/gtk+-2.24.16

mkdir -p share/doc/gtk+-dev-2.24.16
cp -p /source/gtk/2.24/gtk+-2.24.16/COPYING share/doc/gtk+-dev-2.24.16
...
zip -r -D $ZIP share/doc/gtk+-2.24.16
...
zip -r $DEVZIP share/doc/gtk+-dev-2.24.16
