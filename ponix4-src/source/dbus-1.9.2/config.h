...
#define DBUS_TEST_EXEC "/source/dbus-1.9.2/test"

/* Full path to the launch helper test program in the builddir */
#define DBUS_TEST_LAUNCH_HELPER_BINARY "/source/dbus-1.9.2/bus/dbus-daemon-launch-helper-test"
...
#define PACKAGE_STRING "dbus 1.9.2"
...
#define TEST_BUS_LAUNCH_BINARY "/source/dbus-1.9.2/tools/dbus-launch"
