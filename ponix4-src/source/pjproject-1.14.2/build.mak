export PJDIR := /source/pjproject-1.14.2
...
export APP_CC := i486-TSOL-linux-gnu-gcc
export APP_CXX := i486-TSOL-linux-gnu-g++
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-Os -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-Os -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
