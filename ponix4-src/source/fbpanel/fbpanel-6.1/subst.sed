...
s/%%topdir%%/\/build\/source\/fbpanel\/fbpanel-6.1/g
s/%%version%%/6.1/g
...
s/%%cflagsx%%/-I\/build\/source\/fbpanel\/fbpanel-6.1\/panel -I\/usr\/include\/glib-2.0 -I\/usr\/lib\/glib-2.0\/include -pthread -D_REENTRANT -I\/usr\/include\/gtk-2.0 -I\/usr\/lib\/gtk-2.0\/include -I\/usr\/include\/atk-1.0 -I\/usr\/include\/cairo -I\/usr\/include\/pango-1.0 -I\/usr\/include\/gio-unix-2.0\/ -I\/usr\/include\/glib-2.0 -I\/usr\/lib\/glib-2.0\/include -I\/usr\/include\/pixman-1 -I\/usr\/include\/freetype2 -I\/usr\/include\/directfb -I\/usr\/include\/libpng12 -fPIC/g
