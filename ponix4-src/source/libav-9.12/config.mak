...
LIBAV_CONFIGURATION=--prefix=/usr --disable-yasm --enable-shared
prefix=/usr
...
SRC_PATH=.
CC_IDENT=gcc 4.6.3 (crosstool-NG 1.15.2)
ARCH=x86
CC=gcc
AS=gcc
LD=gcc
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=-static-libgcc  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-lasound -lm -pthread -lbz2 -lz 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
