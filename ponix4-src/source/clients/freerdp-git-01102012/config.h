...
#define FREERDP_VERSION_FULL "1.1.0"
...
#define FREERDP_PLUGIN_PATH "/freerdp/lib/freerdp"
#define FREERDP_CLIENT_PLUGIN_PATH "/freerdp/lib/freerdp/client"
#define FREERDP_SERVER_PLUGIN_PATH "/freerdp/lib/freerdp/server"
