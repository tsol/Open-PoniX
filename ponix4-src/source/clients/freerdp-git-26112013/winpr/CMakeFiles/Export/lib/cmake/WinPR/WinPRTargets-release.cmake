...
SET_TARGET_PROPERTIES(winpr PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "-lpthread;dl;/usr/lib/libz.so;/usr/lib/libssl.so;/usr/lib/libcrypto.so;/usr/lib/libz.so;-lpthread;dl;-lpthread;dl;-lpthread;dl;rt;/usr/lib/libz.so;/usr/lib/libssl.so;/usr/lib/libcrypto.so;m;rt;/usr/lib/libssl.so;/usr/lib/libcrypto.so;/usr/lib/libz.so;/usr/lib/libz.so;dl"
...
SET_TARGET_PROPERTIES(winpr-makecert-tool PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "/usr/lib/libz.so;/usr/lib/libssl.so;/usr/lib/libcrypto.so;winpr"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libwinpr-makecert-tool.a"
  )
