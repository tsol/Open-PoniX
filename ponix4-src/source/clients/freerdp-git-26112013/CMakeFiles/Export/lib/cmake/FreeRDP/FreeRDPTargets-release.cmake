...
SET_TARGET_PROPERTIES(freerdp PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "-lpthread;dl;winpr;winpr;winpr;/usr/lib/libssl.so;/usr/lib/libcrypto.so;winpr;/usr/lib/libz.so;winpr;/usr/xorg/lib/libX11.so;/usr/xorg/lib/libxkbfile.so;winpr;winpr;/usr/lib/libz.so;/usr/lib/libssl.so;/usr/lib/libcrypto.so;winpr"
...
SET_TARGET_PROPERTIES(audin-client-alsa PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "freerdp;/usr/lib/libasound.so"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/audin-client-alsa.a"
  )
...
SET_TARGET_PROPERTIES(smartcard-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "freerdp;winpr;pcsclite"
...
# Import target "xfreerdp-client" for configuration "Release"
SET_PROPERTY(TARGET xfreerdp-client APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
SET_TARGET_PROPERTIES(xfreerdp-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "/usr/xorg/lib/libX11.so;dl;/usr/xorg/lib/libXinerama.so;/usr/xorg/lib/libXext.so;/usr/xorg/lib/libXcursor.so;/usr/xorg/lib/libXv.so;/usr/xorg/lib/libXrender.so;freerdp-client;freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libxfreerdp-client.a"
  )
